...
-- Remap de la ostia shot out to Hugo
map("n", "<leader>r", [[:%s/\<<C-r><C-w>\>/<C-r><C-w>/gI<Left><Left><Left>]], { desc = "Replace all occurrences of the word under the cursor", noremap = true })
